...
/**
 * Runs RHMI language server to which a language client (e.g. Visual Code extension) can connect to via socket.
 * 
 * Use for development to start Xtext server in Eclipse without needing to build a JAR file
 * and to enable direct (non-remote) debugging of server in Eclipse.
 */
